        ...
        <div>
            <footer className='footer md:mt-[30px] w-full h-full md:pb-[30px] max-md:mt-[30px] max-md:py-4 '>
                <div className='max-w-6xl max-md:px-6 flex mx-auto md:pt-[30px] border-t-4 border-[#80B500]'>
                    <div className="w-full h-full grid grid-cols-3 justify-between items-start md:mb-[30px] max-md:gap-[8px]">
                        <div className="col-1 flex flex-col md:gap-[10px] max-md:gap-[10px] items-start">
                            <div className="h-full flex">
                                <Link
                                    ...
                                    <img
                                        ...
                                        className="md:h-10 max-md:h-4 md:my-2 max-md:my-2 max-md:mx-3"
                                        alt="Logo"
                                    />
                            ...
                            <h1 className='font-[500] md:text-[18px] max-md:text-[22px] pr-6 text-[#667479]'>Al Mubarak group of companies was started in 1978 in UAE with an opening of departments store in AL AQUA, AL AIN.</h1>


                        </div>
                        <div className="col-23 md:grid md:grid-cols-2 md:mb-[30px] max-md:gap-4 i
                        o max-md:py-4">
                        ...
                        <div className="col-4 flex flex-col md:gap-[24px] max-md:gap-[10px]  max-md:mt-4">
                ...
                <div className='max-w-6xl mx-auto h-[1px] bg-[#000] opacity-[2%] max-md:mt-2'></div>
                <div className="copywrite h-full max-w-6xl mx-auto flex items-center justify-between md:mt-[30px] max-md:mt-[10px]">
                    <p className='font-[400] md:text-[16px] max-md:text-[12px] text-[#667479]'>© 2024 Copyright, All Right Reserved</p>
                    ...
                    <div className="media flex gap-[10px]">
                        <div className='bg-[#80B500] md:h-[42px] md:w-[42px] p-2 rounded-full flex items-center justify-center'>
                            <FaFacebookF className='md:h-6 text-[#FFF]' />
                        </div>
                        <div className='bg-[#80B500] md:h-[42px] md:w-[42px] p-2 rounded-full flex items-center justify-center'>
                            <FaLinkedinIn className='md:h-6 text-[#FFF]' />
                        </div>
                        <div className='bg-[#80B500] md:h-[42px] md:w-[42px] p-2 rounded-full flex items-center justify-center'>
                            <FaInstagram className='md:h-6 text-[#FFF]' />
                        </div>
                        <div className='bg-[#80B500] md:h-[42px] md:w-[42px] p-2 rounded-full flex items-center justify-center'>
                            <FaTwitter className='md:h-6 text-[#FFF]' />
                        </div>
