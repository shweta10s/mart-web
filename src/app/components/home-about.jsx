...
const HomeAbout = () => {
  return (
    <div className='md:h-[80vh] md:w-full relative'>
        <div className='md:h-[60vh] md:w-full'>
        </div>
        <div className='md:h-[20vh] md:w-full bg-[#FF7D09]'>
        </div>
        <div className='absolute top-[5vh] left-0 md:h-[70vh] w-full flex '>

           <div className='max-w-6xl mx-auto flex bg-[#FFF] shadow-lg rounded-[12px]'>
           <div className="left md:w-[40%] md:h-full flex justify-center items-center">
               <div className='relative md:h-[90%] md:w-[90%]'>
               <div className='md:w-[95%] md:h-[95%] border-4 border-[#80B500] absolute top-0 left-0 md:rounded-[4px]'>
                </div>
                <img
