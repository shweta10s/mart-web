...
const HomeContact = () => {
    return (
        <div className='w-full bg-[#FA6D000D]'>
            ...
            <p className="font-[600] md:text-[40px] max-md:text-[24px] md:mt-2 text-[#000]">Contact With Us</p>
            <form 
            // onSubmit={handleSubmit} 
            className='md:mt-4 max-md:mt-2 flex flex-col md:gap-4 max-md:gap-2'>
              ...
              <div className='w-fit '>
                <button className="md:py-[14px] max-md:py-[10px] md:px-[28px] max-md:px-[14px] md:mt-2 max-md:mt-[10px] max-md:text-[14px] border border-[#FF7D09] bg-[#FF7D09] hover:bg-[#FFF] hover:text-[#FF7D09] text-[#FFF] md:rounded-[16px] max-md:rounded-[8px]">
                  Submit 
